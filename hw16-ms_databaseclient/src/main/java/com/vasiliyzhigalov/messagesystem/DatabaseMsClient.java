...
public class DatabaseMsClient implements MsClient {

    private final String name;
    private final Map<String, RequestHandler> handlers = new ConcurrentHashMap<>();
    private final ClientSocket clientSocket;
    private static Logger logger = LoggerFactory.getLogger(DatabaseMsClient.class);


    public DatabaseMsClient(String name, ClientSocket clientSocket) {
        this.name = name;
